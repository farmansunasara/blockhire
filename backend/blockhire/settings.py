"""
Django settings for blockhire project.
"""
...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,blockhire-backend.onrender.com').split(',')
...
WSGI_APPLICATION = 'blockhire.wsgi.application'
...
# Media files - Use S3 for production, local for development
if DEBUG:
    ...
    AWS_STORAGE_BUCKET_NAME = os.getenv('AWS_STORAGE_BUCKET_NAME', 'blockhire-documents-prod')
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://localhost:8000",
    "http://127.0.0.1:8000",
    "https://blockhire-frontend.onrender.com",
]
...
# Cache Configuration (Optional - fallback to local memory)
CACHES = {
    'default': {
